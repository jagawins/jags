      ...
      <section className="py-16 border-t border-border">
        <div className="container-narrow max-w-2xl">
          ...
          <div className="mt-8 space-y-4 text-base text-muted-foreground leading-relaxed">
            <p>
              Jag Mariappan is Executive Director, Research Computing and Informatics at Beth Israel Lahey Health, specializing in research computing, HPC, AI infrastructure, biomedical discovery, and institutional AI deployment at scale. Previously, Jag served at Stanford Medicine and led digital transformation initiatives at Medtronic Diabetes, contributing to the 770G to 780G ecosystem transition and the scaling of connected insulin delivery platforms.
            </p>
            <p className="text-sm">
